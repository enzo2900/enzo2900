...
🚀 **À la recherche d'une opportunité en alternance / d'un stage sur Toulouse**

---

## 🛠️ Stack Technique

* **Back-end :** Java (Spring Boot), Node.js (Next.js), ORM (Prisma)
* **Front-end / Mobile :** Android Java, React, Tailwind CSS
* **Bases de données & Outils :** PostgreSQL, MongoDB, Docker, Git
